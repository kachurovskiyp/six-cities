import { FavoriteOfferProps } from '../../types/props-type';

import { store } from '../../store';
import { fetchFavoriteStatusIn, fetchFavoriteStatusOut } from '../../store/api-actions';

function FavoriteCard({ offer }: FavoriteOfferProps): JSX.Element {
    ...
    <article className="favorites__card place-card">
      ...
      <div className="favorites__card-info place-card__info">
        <div className="place-card__price-wrapper">
          ...
          <button onClick={onFavoriteButtomClick} className="place-card__bookmark-button place-card__bookmark-button--active button" type="button">
